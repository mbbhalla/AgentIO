...
object RetailDatabase {
    ...
    private val TABLES: Set<TableInfo> =
        setOf(
            TableInfo(
                name = TableName("site"),
                ...
                columns =
                    listOf(
                        ColumnInfo(
                            ...
                            false,
                            true,
                            ForeignKeyRef(TableName("site"), ColumnName("site_id")),
                            "Site holding the inventory",
                        ),
                        ColumnInfo(
                            ...
                            false,
                            true,
                            ForeignKeyRef(TableName("product"), ColumnName("product_id")),
            ...
            TableInfo(
                ...
                columns =
                    listOf(
                        ...
                        ColumnInfo(
                            ColumnName("reliability_score"),
                            ColumnType.DOUBLE,
                            false,
                            false,
                            null,
                            "Supplier reliability rating 0.0-1.0",
                        ),
                    ),
            ),
            TableInfo(
                ...
                columns =
                    listOf(
                        ...
                        ColumnInfo(
                            ...
                            false,
                            false,
                            ForeignKeyRef(TableName("supplier"), ColumnName("supplier_id")),
                        ...
                        ColumnInfo(
                            ...
                            false,
                            null,
                            "Order status: PENDING, IN_TRANSIT, DELIVERED, DELAYED",
                        ),
    ...
    private val DDL_STATEMENTS: List<String> =
        listOf(
            """
            CREATE TABLE site (
    ...
    private val INSERTS: List<String> =
        listOf(
            """
