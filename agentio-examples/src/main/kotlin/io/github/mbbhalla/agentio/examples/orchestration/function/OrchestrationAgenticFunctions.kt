...
internal object OrchestrationAgenticFunctionProvider {
    ...
    suspend fun getSecurityWorker(agentId: String, projectPath: String): SecurityWorkerAgenticFunction {
    ...
    suspend fun getQualityWorker(agentId: String, projectPath: String): QualityWorkerAgenticFunction {
    ...
    suspend fun getDocumentationWorker(agentId: String, projectPath: String): DocumentationWorkerAgenticFunction {
    ...
    fun getOrchestrator(agentId: String): OrchestratorAgenticFunction {
        return OrchestratorAgenticFunction(
            AgentConfiguration(
                agentId = agentId,
                languageModelParameters = LanguageModelParameters(
                    llm = LLM.ANTHROPIC_CLAUDE_OPUS_4_5_V1_CROSS_REGION_INFERENCE,
