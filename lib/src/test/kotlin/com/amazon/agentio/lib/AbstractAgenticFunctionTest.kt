package com.amazon.agentio.lib
...
import com.amazon.agentio.lib.ctx.writer.ContextWriters
import com.amazon.agentio.lib.ctx.provider.EmptyContextProvider
import com.amazon.agentio.lib.tool.ToolsProvider
...
import com.amazon.agentio.model.TopP
...
internal class AbstractAgenticFunctionTest {
    ...
    fun `should handle context memory manager failures`() = runBlocking {
        ...
        val failingCmm = object : ContextMemoryManager {
            ...
            ): com.amazon.agentio.model.Conversation =
