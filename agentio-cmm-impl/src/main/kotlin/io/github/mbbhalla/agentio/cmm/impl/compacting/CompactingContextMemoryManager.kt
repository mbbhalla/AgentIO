...
class CompactingContextMemoryManager(
    ...
    data class CompactionInput(
        ...
        override fun instruction() =
            ConversationCompactor.buildCompactionInstruction(conversationText)
    ...
    override fun shouldExecuteOnTurn(turnNumber: Int): Boolean =
        turnNumber > 0 // Skip turn 0 — no token data yet
    ...
    private suspend fun performCompaction(
        ...
        LOG.info(
            ...
            split.middle.size, middleText.length,
            split.anchor.size, split.recent.size,
        )
        ...
        return if (result.isSuccess) {
            ...
            LOG.info(
                ...
                summary.length, middleText.length,
            )
