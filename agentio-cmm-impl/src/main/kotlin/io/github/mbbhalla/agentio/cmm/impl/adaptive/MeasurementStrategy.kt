...
interface MeasurementStrategy {
     ...
     */
    fun parseResponse(responseText: String, registry: ProbeRegistry): List<ProbeResponse>
}
...
object MultiProbeRecallStrategy : MeasurementStrategy {
    ...
    override fun parseResponse(responseText: String, registry: ProbeRegistry): List<ProbeResponse> =
