...
object ContextReshuffler {
    ...
    fun reshuffle(
        ...
        val assigned =
            sortedMovable.zip(sortedPositions).map { (segment, position) ->
        ...
        val unassigned =
            if (sortedMovable.size > sortedPositions.size) {
     ...
     */
    internal fun enforceAdjacencyConstraints(segments: List<ContextSegment>): List<ContextSegment> {
