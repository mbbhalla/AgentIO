...
internal class EventListenersTest {
    ...
    @Test
    fun `should dispatch event to all listeners`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should dispatch to zero listeners without error`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should continue dispatching when a listener fails`() =
        runBlocking {
            // Given
            val received = Collections.synchronizedList(mutableListOf<String>())
            val listeners =
    ...
    @Test
    fun `should not propagate exception when listener throws instead of returning failure`() =
        runBlocking {
    ...
    @Test
    fun `should pass the same event to all listeners`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should handle single listener`() =
        runBlocking {
            // Given
            var invoked = false
            val listeners =
