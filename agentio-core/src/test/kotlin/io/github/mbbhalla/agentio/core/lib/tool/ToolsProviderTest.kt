...
class ToolsProviderTest {
    @Test
    fun `ToolsProvider interface should be implementable`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `custom ToolsProvider implementation should work`() =
        runBlocking {
            // Given
            val customProvider =
    ...
    @Test
    fun `ToolsProvider should handle empty tool list`() =
        runBlocking {
            // Given
            val emptyProvider =
                object : ToolsProvider {
    ...
    @Test
    fun `ToolsProvider should handle tool calls with null input`() =
        runBlocking {
            // Given
            val provider =
                object : ToolsProvider {
