...
internal class AbstractAgenticFunctionTest {
    ...
    @Test
    fun `should handle exceptions and return failure when tools provider fails`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
        ...
        runBlocking {
            ...
            val failingCmm =
                object : ContextMemoryManager {
                    ...
                    ): io.github.mbbhalla.agentio.core.model.conversation.Conversation = throw RuntimeException("Context manager failed")
                }
            val failingConfig =
    ...
    @Test
    fun `should handle bedrock client failures`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle successful conversation with valid JSON output`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle conversation with StopSequence stop reason`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle thinking mode with multiple iterations`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle tool use in conversation flow`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle custom system instruction`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle null problem domain in agent configuration`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should handle null system instruction`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should handle thinking mode reaching max iterations`() =
        runBlocking {
    ...
    @Test
    fun `should handle MaxTokens stop reason`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle ContentGuardRail stop reason`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle ToolUse stop reason`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
    ...
    @Test
    fun `should handle additional model request fields`() =
        runBlocking {
            // Given
            val configWithAdditionalFields =
                agentConfiguration.copy(
                    languageModelParameters =
                        agentConfiguration.languageModelParameters.copy(
    ...
    @Test
    fun `should handle empty usage in response`() =
        runBlocking {
            // Given
            val testInput =
                TestInput(
