...
internal class CheckpointingEventListenerTest {
    ...
    private fun turnCompletedEvent(
        agentId: String,
        turnNumber: Int,
    ): Event =
        Event(
    ...
    @Test
    fun `should checkpoint on every Nth turn`() =
        runBlocking {
            // Given
            val listener =
    ...
    @Test
    fun `should not checkpoint on turn 0`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should checkpoint every turn when n is 1`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should not checkpoint between intervals`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should pass correct agentId in checkpoint`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should include conversation in checkpoint`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should set checkpointTimestamp`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should ignore non-TurnCompleted events`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should return success when no checkpoint needed`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should return success when checkpoint is written`() =
        runBlocking {
            // Given
            val listener =
                CheckpointingEventListener(
    ...
    @Test
    fun `should return failure when writer throws`() =
        runBlocking {
            // Given
