...
internal class ConversationCompactorTest {
    ...
    private fun makeToolResultEnvelope(
        toolUseId: String,
        resultText: String,
    ) = MessageEnvelope(
        message =
    ...
    private fun buildConversation(messages: List<MessageEnvelope>) =
        Conversation(
            messages = messages,
                                    ...
                                    ContentBlock.ToolUse(
                                        value =
                                            aws.sdk.kotlin.services.bedrockruntime.model.ToolUseBlock {
                                                ...
                                                toolUseId = "tool_123"
                                                input =
                                                    aws.smithy.kotlin.runtime.content.Document
                                                        .String("query")
                                            },
                                    ),
                                )
    ...
    fun `reconstruct with empty recent should still produce valid alternation`() {
        ...
        val split =
            ConversationCompactor.ConversationSplit(
