...
internal class AgenticFunctionEvaluatorTest {
    ...
    @Test
    fun `should evaluate successfully with all matching results using withFunction`() =
        runBlocking {
            // Given
            ...
            val evaluationInput =
                AgenticFunctionEvaluator.EvaluationInput.withFunction(
    ...
    @Test
    fun `should handle partial failures and matches`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should handle all failures`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should work with single iteration`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should produce fresh instance per iteration when using withFactory`() =
        runBlocking {
