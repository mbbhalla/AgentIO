...
internal class FileSystemCheckpointWriterTest {
    ...
    @Test
    fun `should write checkpoint file with correct name for EveryNTurns`() =
        runBlocking {
            // Given
    ...
    @Test
    fun `should write valid JSON content`() =
        runBlocking {
            // Given
            val writer = FileSystemCheckpointWriter(directory = tempDir)
    ...
    @Test
    fun `should write multiple checkpoint files without overwriting`() =
        runBlocking {
            // Given
            val writer = FileSystemCheckpointWriter(directory = tempDir)
    ...
    @Test
    fun `should handle agent IDs with special characters`() =
        runBlocking {
            // Given
            val writer = FileSystemCheckpointWriter(directory = tempDir)
